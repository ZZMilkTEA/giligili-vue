...
// 用户注册
const userRegister = form => axios.post('/api/v1/users', form).then(res => res.data);
...
//改变用户信息
const changeUserAvatar = (form, id, token) => axios.put(`/api/v1/users/${id}/avatar`,form,{headers:{'token':token}}).then(res => res.data);
